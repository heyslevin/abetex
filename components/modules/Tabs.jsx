...
export default function Tabs({ data }) {
  ...
  return (
    <main
      ...
      className="flex w-full scroll-mt-10 flex-row justify-center bg-slate-100 p-10 px-4 md:px-28"
    >
      <TabsRadix
                ...
                return (
                  ...
                  >
                    ...
                    <section className="flex h-full w-full flex-row items-center justify-between md:group-rdx-state-active:pb-9">
                      <h1 className="ml-[-2px] text-left text-2xl tracking-tight group-rdx-state-active:text-black group-rdx-state-inactive:text-neutral-500 md:max-w-[90%] md:text-3xl">
                        {tab?.heading}
                      </h1>
